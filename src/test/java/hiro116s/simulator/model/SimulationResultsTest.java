...
class SimulationResultsTest {
    ...
    void toJsonString() throws Exception {
        ...
        assertEquals(
                "{\"seed\":1,\"simulationId\":\"a\",\"parsedData\":{\"score\":1.0,\"params\":{\"N\":1,\"M\":1,\"X\":10}}}\n" +
                        "{\"seed\":2,\"simulationId\":\"b\",\"parsedData\":{\"score\":10.0,\"params\":{\"N\":1,\"M\":2}}}\n" +
                        "{\"seed\":3,\"simulationId\":\"c\",\"parsedData\":{\"score\":100.0,\"params\":{\"N\":2,\"M\":2}}}",
